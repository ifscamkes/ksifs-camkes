...
/**
 * @xmlonly <manual name="rwfm_RegisterSubject" label="rwfm_RegisterSubject"/> @endxmlonly
 * @brief Register a subject for sel4 level RWFM
 *
 *
 * @param[in] compName The component name.
 * @param[in] compNo The component ID generated by rwfm python script.
 * @param[in] owner The owner of the component.
 * @param[in] reader The readers set encoded into bits.
 * @param[in] writer The writers set encoded into bits.
 */
LIBSEL4_INLINE_FUNC void
rwfm_RegisterSubject(char* compName, seL4_Word compNo, seL4_Word owner, seL4_Word reader, seL4_Word writer);

/**
 * @xmlonly <manual name="rwfm_RegisterInterface" label="rwfm_RegisterInterface"/> @endxmlonly
 * @brief Register an interface for sel4 level RWFM
 *
 *
 * @param[in] intName The interface name.
 * @param[in] intNo The interface ID generated by rwfm python script.
 * @param[in] owner The owner of the interface.
 * @param[in] reader The readers set encoded into bits.
 * @param[in] writer The writers set encoded into bits.
 */
LIBSEL4_INLINE_FUNC void
...
/**
 * @xmlonly <manual name="rwfm_RegisterEndpoint" label="rwfm_RegisterEndpoint"/> @endxmlonly
 * @brief Register an endpoint specific to a component
 *
 *
 * @param[in] epNo The endpoint number assigned by camkes python script.
 * @param[in] compNo The owner of the endpoint.
 * @param[in] compName The owner name.
 * @param[in] intID The interface ID for the generated endpoint.
 * @param[in] intName The interface name.
 */
LIBSEL4_INLINE_FUNC void
rwfm_RegisterEndpoint(seL4_Word epNo, seL4_Word compNo, char* compName, seL4_Word intID, char* intName);

/**
 * @xmlonly <manual name="rwfm_RegisterThread" label="rwfm_RegisterThread"/> @endxmlonly
 * @brief Register the Thread of a component
 *
 *
 * @param[in] thrNo The thread ID given by camkes to each component thread.
 * @param[in] thrName The thread Name.
 * @param[in] compNo The component corresponding to thread.
 * @param[in] compName The component Name.
 */
LIBSEL4_INLINE_FUNC void
...
/**
 * @xmlonly <manual name="rwfm_CheckReadRule" label="rwfm_CheckReadRule"/> @endxmlonly
 ...
 *
 * @param[in] intNo The interface from where the component shall read from.
...
/**
 * @xmlonly <manual name="rwfm_CheckWriteRule" label="rwfm_CheckWriteRule"/> @endxmlonly
 * @brief Return the status whether RWFM stopped the data flow or not for the last data flow that happened.
 * Only use it after you have sent some data.
 *
 * @param[in] compNo The component number where the data is flowing from.
...
/**
 * @xmlonly <manual name="rwfm_PerformLabelUpdate" label="rwfm_PerformLabelUpdate"/> @endxmlonly
 * @brief Return the status whether RWFM stopped the data flow or not for the last data flow that happened.
 * Only use it after you have sent some data.
 *
 * @param[in] intNo The interface from where the component shall read from.
