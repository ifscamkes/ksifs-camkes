...
static inline void
x64_sys_rwfm_CheckReadRule(seL4_Word sys, seL4_Word msg0, seL4_Word msg1, seL4_Word *status)
{
    /*Todo: Add similar function in syscalls_sysenter.h file also, to be workable in 32-bit systems.*/
...
static inline void
x64_sys_rwfm_CheckWriteRule(seL4_Word sys, seL4_Word msg0, seL4_Word msg1, seL4_Word *status)
{
    /*Todo: Add similar function in syscalls_sysenter.h file also, to be workable in 32-bit systems.*/
    register seL4_Word mr0 asm("r10") = msg0;
    register seL4_Word mr1 asm("r8") = msg1;
...
static inline void
x64_sys_rwfm_PerformLabelUpdate(seL4_Word sys, seL4_Word msg0, seL4_Word msg1, seL4_Word *status)
{
    /*Todo: Add similar function in syscalls_sysenter.h file also, to be workable in 32-bit systems.*/
    register seL4_Word mr0 asm("r10") = msg0;
    register seL4_Word mr1 asm("r8") = msg1;
