...
rwfm_CheckReadRule(seL4_Word intNo, seL4_Word compNo) {
    seL4_Word status;
    x64_sys_rwfm_CheckReadRule(seL4_Sysrwfm_CheckReadRule, intNo, compNo, &status);
    return status;
}

LIBSEL4_INLINE_FUNC seL4_Word
rwfm_CheckWriteRule(seL4_Word compNo, seL4_Word intNo) {
    seL4_Word status;
    x64_sys_rwfm_CheckWriteRule(seL4_Sysrwfm_CheckWriteRule, compNo, intNo, &status);
    return status;
}

LIBSEL4_INLINE_FUNC seL4_Word
rwfm_PerformLabelUpdate(seL4_Word intNo, seL4_Word compNo) {
    seL4_Word status;
    x64_sys_rwfm_PerformLabelUpdate(seL4_Sysrwfm_PerformLabelUpdate, intNo, compNo, &status);
    return status;
}
